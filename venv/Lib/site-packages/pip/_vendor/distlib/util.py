...
def get_resources_dests(resources_root, rules):
    """Find destinations for dbmodel files"""
...
class Cache(object):
    """
    A class implementing a cache for dbmodel that need to live in the file system
    e.g. shared libraries. This class was moved from dbmodel to here because it
